...
public class KnowledgeIndexProperties {
  ...
  private String decompiledSourceRoot = "/srv/knowledge-index/knowledge-index/source";
  ...
  public String getDecompiledSourceRoot() {
    return decompiledSourceRoot;
  }

  public void setDecompiledSourceRoot(String decompiledSourceRoot) {
    this.decompiledSourceRoot = decompiledSourceRoot;
  }
