...
@TestPropertySource(properties = {
    ...
    "server.servlet.context-path=/agent-task-manager"
})
class McpNoAuthTransportIntegrationTest extends IntegrationTestSupport {
  ...
  private HttpResponse<String> postJson(String sessionId, Map<String, Object> payload) throws Exception {
    ...
    HttpRequest.Builder requestBuilder = HttpRequest.newBuilder()
        .uri(URI.create("http://127.0.0.1:" + port + "/agent-task-manager/mcp"))
