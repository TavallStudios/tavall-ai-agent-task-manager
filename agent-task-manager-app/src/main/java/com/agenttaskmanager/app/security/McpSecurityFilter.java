...
public class McpSecurityFilter implements Filter {
  ...
  private final com.agenttaskmanager.app.security.McpApiKeyAuthenticationService apiKeyAuthenticationService;
  private final com.agenttaskmanager.app.security.AuthenticatedClientContextHolder contextHolder;

  public McpSecurityFilter(
      SecurityProperties securityProperties,
      com.agenttaskmanager.app.security.McpApiKeyAuthenticationService apiKeyAuthenticationService,
      com.agenttaskmanager.app.security.AuthenticatedClientContextHolder contextHolder
  ) {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    try {
      Optional<com.agenttaskmanager.app.security.AuthenticatedClientContext> authenticated = authenticate(httpRequest);
  ...
  private Optional<com.agenttaskmanager.app.security.AuthenticatedClientContext> authenticate(HttpServletRequest request) {
    Optional<com.agenttaskmanager.app.security.AuthenticatedClientContext> apiKeyContext = authenticateApiKey(request);
    ...
    if (securityProperties.isProxyAuthEnabled()) {
      ...
      if (headerValue != null && !headerValue.isBlank()) {
        return Optional.of(new com.agenttaskmanager.app.security.AuthenticatedClientContext(
            "proxy-header",
            headerValue.strip(),
            "",
            "proxy",
  ...
  private Optional<com.agenttaskmanager.app.security.AuthenticatedClientContext> authenticateApiKey(HttpServletRequest request) {
  ...
  private Optional<com.agenttaskmanager.app.security.AuthenticatedClientContext> authenticateBasicAuth(HttpServletRequest request) {
    String authorization = request.getHeader("Authorization");
