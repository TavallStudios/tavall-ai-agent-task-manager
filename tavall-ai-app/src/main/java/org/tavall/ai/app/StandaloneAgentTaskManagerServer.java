...
import org.tavall.ai.app.desktop.DesktopOperationCatalogService;
import org.tavall.ai.app.desktop.DesktopRemoteRunnerService;
import org.tavall.ai.app.http.DesktopControlPlaneServlet;
...
import org.tavall.ai.app.security.McpSecurityFilter;
...
public final class StandaloneAgentTaskManagerServer implements AutoCloseable {
  ...
  private static Path createBaseDir() {
    try {
      return Files.createTempDirectory("tavall-ai-standalone");
