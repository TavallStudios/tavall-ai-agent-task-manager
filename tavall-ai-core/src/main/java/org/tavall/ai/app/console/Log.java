...
package org.tavall.ai.app.console;

import org.tavall.ai.app.console.style.LogColors;
import org.tavall.ai.app.console.style.LogText;
...
public class Log {
  ...
  private static boolean isAppFrame(StackTraceElement ste) {
    ...
    return className.startsWith("org.tavall.ai.");
  }
