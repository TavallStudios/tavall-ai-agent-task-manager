...
public class McpServerProperties {
  ...
  private String baseUrl = "https://docs.tavall.org/tavall-ai";
  private String endpoint = "/mcp";
  private String backendRegistryPath = Path.of(System.getProperty("user.dir"), "mcp-servers", "tavall-ai-backends.json").toString();
